...
export function SessionSidebar({ sessions, activeId, onSelect, onNew }: SessionSidebarProps) {
  return (
    <div className="session-sidebar">
      ...
      <div className="session-sidebar__nav">
        <a href="#/market" className="session-sidebar__nav-link">마켓</a>
        <a href="#/my-listings" className="session-sidebar__nav-link">내 상품 관리</a>
      </div>
    </div>
  );
}
