...
def diagnose_publish_failure_tool(
    ...
    return make_tool_call("diagnose_publish_failure_tool", tool_input, output, success=True)
...
async def discord_alert_tool(
    ...
    try:
        ...
        if not webhook_url:
            return make_tool_call("discord_alert_tool", tool_input, {"sent": False}, success=True)
