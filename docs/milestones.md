...
| M135: 게시 UX 통합 + RLS + 문서 | ✅ 완료 | 세션 ID 수동 복사 제거(publish_bridge.js Content Script로 웹앱→익스텐션 자동 통신) ✅, PublishResultCard "자동 게시" 버튼(window.postMessage) ✅, RLS 마이그레이션 파일화(003_rls_policies.sql) ✅, 문서 정합화 ✅, 723 테스트 통과 ✅ |
