...
| M7: 실행 안정화·테스트 회복 | 진행 중 | SellerCopilotRunner asyncio.run 제거·단순화(325줄→68줄, Adapter/magic 전면 제거) ✅, PublishService.execute_publish 분리 ✅, SessionService publish 루프 위임 ✅ |
